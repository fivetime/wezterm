...
pub struct Surface {
    ...
    // window resizing.
    // wezterm: atomic, so that it can be switched through the shared
    // reference that `wgpu::Surface::as_hal` hands out
    pub present_with_transaction: atomic::AtomicBool,
}
